...
<template>
  <main
    class="bg-black pt-16 h-dvh relative bg-opacity-40 flex justify-around items-center flex-col"
  >
    <img
      class="absolute left-0 top-0 h-full w-full -z-10 object-cover"
      src="../img/intro_img.jpeg"
      alt="bg"
    />
